...
class SkillLoader:
    ...
    def get_catalog_text(self) -> str:
        """返回轻量级目录文本"""
        if not self.catalog:
            return "No skills available. You can only use built-in tools."
        
        lines = ["CRITICAL: You MUST use activate_skill(name) BEFORE any skill-related task. DO NOT guess or make up responses about skills.", ""]
        lines.append("Available skills (use activate_skill to load full instructions):")
